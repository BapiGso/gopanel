...
require (
	...
	github.com/creachadair/taskgroup v0.14.3 // indirect
	...
	github.com/tailscale/setec v0.0.0-20260415230416-802071d7d5bf // indirect
	...
	modernc.org/ccgo/v4 v4.34.1 // indirect
